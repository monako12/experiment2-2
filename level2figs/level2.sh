...
./bp_mo_exor 1000 | grep FINISH > log.txt
./bp_mo_exor 2000 | grep FINISH >> log.txt
./bp_mo_exor 3000 | grep FINISH >> log.txt
./bp_mo_exor 4000 | grep FINISH >> log.txt
./bp_mo_exor 5000 | grep FINISH >> log.txt
./bp_mo_exor 6000 | grep FINISH >> log.txt
./bp_mo_exor 7000 | grep FINISH >> log.txt
./bp_mo_exor 8000 | grep FINISH >> log.txt
./bp_mo_exor 9000 | grep FINISH >> log.txt
./bp_mo_exor 10000 | grep FINISH >> log.txt
